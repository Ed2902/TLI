...
export function FtlLclHero() {
  return (
    <section
      className='relative overflow-hidden bg-gradient-to-br from-[#fff7ef] via-[#ffffff] to-[#eefcf4] px-6 py-20 text-slate-900'
      data-aos='fade-up'
    >
      ...
      <div className='mx-auto grid w-full max-w-7xl gap-8 lg:grid-cols-[1.15fr_0.85fr] lg:items-center'>
        <div className='max-w-3xl' data-aos='fade-right'>
          <p className='mb-4 inline-flex rounded-full bg-[#0a4eb6]/10 px-4 py-2 text-sm font-bold uppercase tracking-[0.3em] text-[#0a4eb6]'>
            Truck Freight
          </p>
          ...
          <div className='mt-8 flex flex-wrap gap-4'>
            ...
            <div className='rounded-2xl border border-[#2cad3f]/15 bg-white px-5 py-4 shadow-sm'>
              <p className='text-sm font-bold uppercase tracking-[0.25em] text-[#2cad3f]'>
                Efficient
              </p>
              <p className='mt-1 text-lg font-semibold text-slate-900'>
                LCL cost control
            ...
            <div className='rounded-2xl border border-[#18aeea]/15 bg-white px-5 py-4 shadow-sm'>
              <p className='text-sm font-bold uppercase tracking-[0.25em] text-[#18aeea]'>
                Visibility
              </p>
              <p className='mt-1 text-lg font-semibold text-slate-900'>
